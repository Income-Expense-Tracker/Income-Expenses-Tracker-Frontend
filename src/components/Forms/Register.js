        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-sm mx-auto">
            ...
            <form onSubmit={onSubmitHandler}>
              ...
              <button
                className="inline-block py-3 px-7 mb-2 w-full text-base text-green-50 font-medium text-center leading-6 bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-md shadow-sm"
                type="submit"
              >
                Register
              </button>
              <p className="text-center">
                <span className="text-xs font-medium">
                  ...
                  <button
                    className="inline-block text-xs font-medium text-green-500 hover:text-green-600 hover:underline m-2"
                    type="submit"
                  >
